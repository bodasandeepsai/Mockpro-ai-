  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      try {
        ...
        const interviewQuestions = generateInterviewQuestionsFromResponse(questionResponse, jobPosition, jobDesc, jobExperience);
        
        const MockJsonResp = JSON.stringify(interviewQuestions);
